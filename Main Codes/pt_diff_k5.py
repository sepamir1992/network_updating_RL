        ...
        with open("pt"+str(num+1)+".txt", "r") as file_2:
            ...
            with open("pt"+str(num+2)+".txt", "r") as file_3:
                ...
                with open("pt"+str(num+3)+".txt", "r") as file_4:
                    ...
                    with open("pt"+str(num+4)+".txt", "r") as file_5:
                        file_5_text = file_5.read().splitlines()
                        
                        with open("pt"+str(num+5)+".txt", "r") as file_6:
                            file_6_text = file_6.read().splitlines()
                            ...
                            for m in (file_5_text):
                                pti.append(m)
                                
                            for n in (file_6_text):
                                ptj.append(n)
